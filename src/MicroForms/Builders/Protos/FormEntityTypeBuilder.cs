...
public class FormEntityTypeBuilder : BuilderBase
{
	...
	public class FormEntityTypeBuilder<TEntity> : FormEntityTypeBuilder where TEntity : class
{
  ...
  //  {
  //      Confirmations.Add(new ConfirmationDetailsExtended { Type = type, Message = message, Buttons = buttons });

  //      return this;
  //  }

  //  public virtual FormEntityTypeBuilder<TEntity> ConfirmDialog([NotNull] Type form, ConfirmType type, ConfirmButtons buttons)
  //  {
  //      Confirmations.Add(new ConfirmationDetailsExtended 
  //      { 
  //          Type = type, 
  //          DialogType = form.Name,
  //          Buttons = buttons 
  //      });
  ...
  //  public virtual FormEntityTypeBuilder<TEntity> Confirm<TProperty>(
		//	[NotNull] Expression<Func<TEntity, TProperty>> propertyExpression, 
  //      ConfirmType type, ConfirmButtons buttons, string anchorBinding = null)
		//{
		//	Confirmations.Add(new ConfirmationDetailsExtended
		//	{
		//		Type = type,
		//		Buttons = buttons,
		//		MessageBinding = propertyExpression.Body.ToString().ReplaceLambdaVar(),
  //          Anchor = anchorBinding
        ...
        where TKey : class
    {
        ...
        resultField.BindingControlType = BindingControlTypes.RepeaterBindingControlType;
        resultField.ControlType = ControlType.Repeater.ToString();
        ...
        where TKey : class
    {
        ...
        resultField.BindingControlType = BindingControlTypes.TableBindingControlType;
        resultField.ControlType = ControlType.Table.ToString();
